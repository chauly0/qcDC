...
% used to calculate transit time.  
...
% Updated by Chau Ly (November 2018)
...
if templateSize == 3
    ...
    %for 32 line
    spacing = 7;
    %spacing = 14; for 16 line code Version 8
    %spacing = 28; for 8 line code Version 6
else
    ...
    %for 32 line
    spacing = 8;
    %spacing = 16; for 16 line code Version 8
    %spacing = 32; for 8 line code Version 6
end
...
%% To show the mask when aligned and offsetted to the particular video frame
% imshow(mask)
